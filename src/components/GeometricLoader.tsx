    ...
    <div className="flex flex-col items-center justify-center p-12">
      <style>{`
        ...
        .geometric-loader:before {
          ...
          width: 200%;
          background: 
            linear-gradient(90deg, var(--loader-color, #3b82f6) 50%, #0000 0),
      ...
      <div 
        ...
        style={{ '--loader-color': 'hsl(var(--primary))' } as React.CSSProperties}
      />
      <p className="mt-8 text-sm font-medium text-muted-foreground animate-pulse tracking-wide italic">
        Loading...
      </p>
    </div>
  );
